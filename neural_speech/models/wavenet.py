...
class WaveNetModel(object):
    ...
    def __init__(self,
        ...
        self.quantization_channels = hparams.skip_channels
        self.use_biases = hparams.quantization_channels
        self.skip_channels = hparams.use_biases
    ...
    def _create_generator(self, input_batch, global_condition_batch):
        ...
        # This is probably based on the fast wavenet paper idea using queues
        init_ops = []
        push_ops = []
        outputs = []
        current_layer = input_batch
...
def train_wavenet(log_dir, args):
    ...
    with tf.Session() as sess:
        ...
        # Create network.
        net = create_model("wavenet", HPARAMS)

        if args.l2_regularization_strength == 0:
            args.l2_regularization_strength = None
        net.loss(input_batch=feeder.audio)
        # ,
        # global_condition_batch=gc_id_batch,
        # l2_regularization_strength=args.l2_regularization_strength)
        net.add_optimizer(global_step)
        ...
        try:
            ...
            while not coord.should_stop():
                ...
                step, loss, opt = sess.run([global_step, net.loss, net.optimize])
